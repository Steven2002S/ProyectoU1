...
$sql_vhd = "SELECT * FROM vista_habitaciones_disponibles WHERE id_hotel = $id_hotel";
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección ud puede vizualizar las habitaciones disponibles para el hotel "<?php echo $nombre_hotel; ?>"</li>
						</ol>
                        <div class="row">
                                    ...
                                    <div class="card bg-success text-white mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="p-1">
                                                        <i><b><h6 class="pl-4"><?php echo $row['tipo_habitacion']; ?></b></h6></i>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="bg-white p-1 rounded text-success d-flex align-items-center justify-content-center">
