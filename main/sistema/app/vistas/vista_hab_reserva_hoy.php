...
$sql_vhd = "SELECT * FROM vista_reservas_dia_actual WHERE id_hotel = $id_hotel";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Habitaciones reservadas - Hoy</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección ud puede vizualizar las habitaciones reservadas el dia de hoy - "<?php echo $nombre_hotel; ?>"</li>
						</ol>
                        <div class="row">
