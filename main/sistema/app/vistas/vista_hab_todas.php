...
$sql_vhd = "SELECT * FROM vista_hab_todas WHERE id_hotel = $id_hotel";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Habitaciones del hotel</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección ud puede vizualizar todas las habitaciones del hotel "<?php echo $nombre_hotel; ?>"</li>
						</ol>
                        <div class="row">
                            <?php while ($row = $result_vhd->fetch_assoc()) { ?>
                                <div class="col-xl-3 col-md-6">
                                    <div class="card <?php echo $row['disponibilidad'] == 0 ? 'bg-danger' : 'bg-success'; ?> text-white mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="bg-white rounded text-dark d-flex align-items-center justify-content-center">
                                                        <h6><?php echo $row['fecha_fin']; ?></h6>
                                                    </div>
                                                </div>
                                                <?php } else { ?>
                                                <div class="col">
                                                    <div class="">
                                                        <i><b><h5 class="pr-4"><?php echo $row['tipo_habitacion']; ?></b></h5></i>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <?php if ($row['disponibilidad'] == 1) {?>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white" href="vista_aplicar_reservacion.php?id_habitacion=<?php echo $row['id_habitacion'];  ?>&id_hotel=<?php echo $id_hotel; ?>">Aplicar reservación</a>
